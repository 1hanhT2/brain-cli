...
1. Obtain the writing goal, target Markdown file from the current invocation, and preferred fixed interval or interval range. Default to 10 minutes when the user does not care.
